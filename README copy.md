# Base Project with All My Shit

This repository is a **base project** containing reusable primitives, hooks, and components for building React Native apps with:
...
1. **Clone the repo**
   ...
   ```bash
   git clone https://github.com/malachyfernandez/base-with-all-my-shit.git
   cd base-with-all-my-shit
   ```
...
1. **Clone into a new folder**
   ...
   ```bash
   git clone https://github.com/malachyfernandez/base-with-all-my-shit.git my-new-app
   cd my-new-app
   ```
